...
function Navbar() {
  ...
  return (
    <>
      <div className='w-screen h-14 bg-slate-800 flex items-center justify-between group'>
        <div className=" text-white block  lg:hidden"  onClick={hamburger()}>
        ...
        <div className="flex w-60 text-white gap-14 items-center">
