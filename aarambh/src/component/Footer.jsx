      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex space-x-4">
            ...
            <p>Aarambh is a website that provides resources and tutorials information for computer science and programming enthusiasts, assisting them in their learning journey.</p>
          </div>
          <div>
